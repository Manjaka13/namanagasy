			...
			<div className="container h-100">
				...
				<div className="contacts__side h-100">
					...
					<form className="contacts__form f-c-st-st" onSubmit={ () => handleSubmit() }>
						<input className="input tr-200 br-5 mg-b-20 pd-10 pd-l-20 pd-r-20" type="email" placeholder="Enter your email" required />
						<textarea className="input tr-200 textarea br-5 mg-b-20 pd-10 pd-l-20 pd-r-20" placeholder="Enter your message"></textarea>
